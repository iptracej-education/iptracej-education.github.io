...
- Architecture Validation: Comparative analysis of Transformer-based models vs. Graph Neural Networks for identifying 'missing check' vulnerabilities in firmware.

- Research: Proposing a new methodology for detecting race conditions in stripped binary firmware by lifting binaries to high-level intermediate representations for semantic analysis.

This work builds upon my 20-year tenure leading security initiatives at Microsoft, bridging the gap between operational security expertise and modern AI innovation.

👋Stay tuned — exciting developments ahead.

### Want to hire me?

So, you’ve stumbled upon my blog and thought, “I want to work with this person!” Well, I am flattered!

If you’re looking for a Security AI/ML Engineer who moves beyond standard coding to build intelligent frameworks for vulnerability discovery, you’re in luck.

I specialize in LLM-enhanced security, bridging the gap between operational expertise and modern deep learning
